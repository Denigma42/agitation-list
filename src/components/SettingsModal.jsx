...
import useDeleteAllDistricts from "../hooks/useDeleteAllDistricts";
...
export default function SettingsModal({
    ...
    const { deleteAllDistricts } = useDeleteAllDistricts();
    ...
    const confirmDeleteData = async () => {
        if (deleteInput == quantityPlatoons) {
            ...
            setDeleteError('Неверно введёно кол-во районов. Удаление данных отменено.');
        }
    }
    ...
    return (
        <>
            ...
            >
                <Stack>
                    <Group justify="space-between">
                        <Text>Полностью удалить районы и очистить архив</Text>
                        <Button
                    ...
                    <Group justify="space-between">
                        <Text>Перевести районы и школы на СЛЕДУЮЩИЙ год</Text>
                        <Button
                    ...
                    <Group justify="space-between">
                        <Text>Перевести районы и школы на ПРОШЛЫЙ год</Text>
                        <Button
            ...
            <Modal opened={openedConfirmDeleteModal} onClose={confirmDeleteModal.close} centered title="Удалить все данные?" size="md">
                <Stack>
                    <Text>Для подтверждения удаления введите кол-во районов: <b>{quantityPlatoons}</b></Text>
                    <Input value={deleteInput} onChange={e => setDeleteInput(e.target.value)} placeholder="Введите кол-во районов..." />
